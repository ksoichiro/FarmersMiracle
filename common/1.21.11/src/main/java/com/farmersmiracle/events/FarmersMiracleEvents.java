...
public class FarmersMiracleEvents {
    private static final Identifier ADV_THE_FIRST_HARVEST =
            Identifier.fromNamespaceAndPath(FarmersMiracle.MOD_ID, "the_first_harvest");
    private static final Identifier ADV_FRUIT_OF_THE_EARTH =
            Identifier.fromNamespaceAndPath(FarmersMiracle.MOD_ID, "fruit_of_the_earth");
    private static final Identifier ADV_A_JUICY_REWARD =
            Identifier.fromNamespaceAndPath(FarmersMiracle.MOD_ID, "a_juicy_reward");
    private static final Identifier ADV_PILGRIMAGE_OF_GRAINS =
            Identifier.fromNamespaceAndPath(FarmersMiracle.MOD_ID, "pilgrimage_of_grains");
    ...
    private static void onAdvancement(ServerPlayer player, AdvancementHolder advancementHolder) {
        ...
        PlayerBuffData data = PlayerBuffData.get(((net.minecraft.server.level.ServerLevel) player.level()).getServer().overworld());
